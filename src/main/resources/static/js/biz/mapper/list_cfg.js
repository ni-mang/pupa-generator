layui.use(['form', 'table','miniPage','element'], function () {
    ...
    table.on('toolbar(mapperTable)', function (obj) {
        if (obj.event === 'add') {   // 监听添加操作
            let content = miniPage.getHrefContent(pagePath + '/mapper/add_cfg.html' + param);
    ...
    table.on('tool(mapperTable)', function (obj) {
        ...
        if (obj.event === 'edit') {
            ...
            let content = miniPage.getHrefContent(pagePath + '/mapper/edit_cfg.html' + param + "&id=" + rowData.id);
